...
public class CurrencyConversionBean {
	...
	public String toString() {
		return "CurrencyConversionBean [id=" + id + ", from=" + from + ", to=" + to + ", conversionMultiple="
				...
				+ ", port=" + port + ", getId()=" + getId() + ", getFrom()=" + getFrom() + ", getTo()=" + getTo()
				+ ", getConversionMultiple()=" + getConversionMultiple() + ", getQuantity()=" + getQuantity()
				+ ", getTotalCalculatedAmount()=" + getTotalCalculatedAmount() + ", getPort()=" + getPort()
